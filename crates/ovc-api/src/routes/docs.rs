...
fn cli_docs() -> Vec<DocSection> {
    vec![
        ...
        DocSection {
            ...
            content: concat!(
                "# Web UI & Server\n\n",
                "These commands are intended for browser access, automation, and server deployments. ",
                "The native desktop app starts its own private service and does not require these commands.\n\n",
                "## `ovc serve`\n\n",
...
fn ui_docs() -> Vec<DocSection> {
    vec![
        DocSection {
            ...
            category: "ui".into(),
            title: "Getting Started with Desktop and Web".into(),
            content: concat!(
                "# Getting Started with Desktop and Web\n\n",
                "OVC provides the same interface in the native desktop app and in a browser.\n\n",
                "## Desktop App\n\n",
                "Install OVC from the latest GitHub release, then open it from your operating system. ",
                "The app starts its private local service automatically. It does not require the CLI, ",
                "a daemon, or a separately configured server.\n\n",
                "A new installation opens onboarding. Enter your author name, author email, first ",
                "repository name, and encryption password. OVC stores the identity in the encrypted ",
                "repository configuration.\n\n",
                "## Browser UI\n\n",
                "1. **Start the server:** Run `ovc serve --repos-dir /path/to/repos`\n",
                "2. **Open the UI:** Navigate to `http://localhost:9742`, or run `ovc web`\n",
                "3. **Login:** Enter the configured server password\n",
                "4. **Select a repository:** The list shows all `.ovc` files in the repository directory\n\n",
                "## Navigation\n\n",
                ...
                "- **Tags:** Tag management\n",
                "- **Changes:** Staged and unstaged file status\n",
            ...
            tags: vec!["getting started".into(), "setup".into(), "desktop".into(),
                       "install".into(), "onboarding".into(), "login".into(),
...
pub async fn get_docs_index() -> Json<DocsIndexResponse> {
    ...
    Json(DocsIndexResponse {
        categories: vec![
            ...
            DocCategory {
                id: "ui".into(),
                title: "Desktop and UI Guide".into(),
